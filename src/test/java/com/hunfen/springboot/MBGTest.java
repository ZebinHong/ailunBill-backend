...
//        gc.setFileOverride(false); //重新生成时文件是否覆盖
        ...
        strategy.setTablePrefix(prefix);//设置表前缀不生成
...
//        strategy.setEntityBooleanColumnRemoveIsPrefix(true);//去掉布尔值的is_前缀
        ...
        //设置BaseEntity
//        strategy.setSuperEntityClass("com.hufeng.springcloud.service.base.model.BaseEntity");
//        // 填写BaseEntity中的公共字段
